      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl font-semibold tracking-tighter text-text-primary text-balance">
            Get Qurus on your Android phone today.
          </h2>
          <p className="mt-4 text-text-secondary text-base sm:text-lg leading-relaxed text-balance">
            Direct APK download. Safe, completely free, and installs in less than 30 seconds without needing an app store account.
          </p>
        </motion.div>

        {/* Main Download Card with Motion Entrance */}
        <motion.div
        ...
        >
          <div className="doppelrand-core p-8 sm:p-14 text-center flex flex-col items-center bg-gradient-to-b from-surface/50 to-white">
            ...
            <div className="flex flex-wrap justify-center items-center gap-2 text-xs font-semibold text-text-secondary mb-6">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-border shadow-2xs">
            ...
            <h3 className="text-2xl sm:text-4xl font-semibold tracking-tight text-text-primary mb-3">
              Qurus for Android
            </h3>
            <p className="text-text-secondary text-sm sm:text-base max-w-lg mb-8 text-balance">
              Full offline capability, verified bilingual audio, and screen-off lock-screen controls. 100% free and open-source under the MIT license.
            </p>

            {/* High-Converting Download Button Row */}
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
              <motion.a
                whileHover={{ scale: 1.03, y: -1 }}
                whileTap={{ scale: 0.97 }}
                href="/api/download"
                className="group relative flex items-center justify-between gap-4 w-full sm:w-auto pl-7 pr-2.5 py-2.5 rounded-full bg-primary hover:bg-primary-hover text-white text-base font-semibold shadow-[0_12px_32px_rgba(14,107,92,0.25)] transition-colors active:scale-[0.98]"
              >
            ...
            {/* 3 Simple Install Steps for Users */}
            <div className="mt-12 pt-8 border-t border-border-subtle grid grid-cols-1 sm:grid-cols-3 gap-5 text-left w-full max-w-2xl">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-xs font-bold text-text-primary">Download File</div>
                  <div className="text-[11px] text-text-secondary mt-0.5">
                    Tap the button above to download the APK.
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-xs font-bold text-text-primary">Tap Install</div>
                  <div className="text-[11px] text-text-secondary mt-0.5">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-xs font-bold text-text-primary">Start Reading</div>
                  <div className="text-[11px] text-text-secondary mt-0.5">
                    Open Qurus and explore. No account needed.
                  </div>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="mt-8 text-xs font-mono text-text-tertiary hover:text-text-primary transition-colors cursor-pointer flex items-center gap-1.5"
            >
              <span>{showTechnicalDetails ? "− Hide package details" : "+ Inspect package safety & permissions"}</span>
            </button>
            ...
            <AnimatePresence>
              {showTechnicalDetails && (
                ...
                >
                  <div className="mt-5 p-5 rounded-2xl bg-surface border border-border text-left text-xs space-y-2.5">
                    <div className="flex justify-between">
                      <span className="text-text-tertiary">Package ID:</span>
                      <span className="font-mono text-text-primary">com.hamdan_khubaib.Qurus</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-text-tertiary">Build Target:</span>
                      <span className="font-mono text-text-primary">Android 8.0 (API 26+)</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-text-tertiary">Permissions:</span>
                      <span className="text-text-primary">Microphone (for private voice notes only)</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-text-tertiary">License:</span>
                      <span className="text-text-primary font-medium">MIT Permissive Open Source</span>
                    </div>
                  </div>
                </motion.div>
              )}
