      ...
      <div className="max-w-4xl mx-auto px-5 sm:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }} className="doppelrand-shell">
          <div className="doppelrand-core p-8 sm:p-12 md:p-16 space-y-8 text-text-primary">
            ...
            <p className="text-base sm:text-lg leading-relaxed text-text-secondary">Qurus is built to make that first step easier: a calm interface, Arabic alongside Urdu and five global translations, background listening, and private space for the thoughts that a verse leaves with you. No ads, no accounts, and no algorithmic feed competing for your attention.</p>
            <p className="text-base sm:text-lg leading-relaxed text-text-secondary">With v2.3.0, we introduced a gentle motivation engine and structured journeys. The goal isn’t to make you speedrun the Quran — it’s to help you build a quiet daily habit that stays with you: <strong className="text-text-primary font-medium">Study with freedom. Stay consistent. Reflect deeper.</strong></p>
